...
class RumbleVideoSourceScraperTests {
    ...
    fun videoSrcIsCorrectForUrl_1() {
        val jsoupResponse = rumbleScraper.scrpVideoSource("v1ieskt")
    ...
    fun videoSrcIsCorrectForUrl_2() {
        val jsoupResponse = rumbleScraper.scrpVideoSource("v1mh9nz")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_3() {
        val jsoupResponse = rumbleScraper.scrpVideoSource("v1mll2a")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_4() {
        val jsoupResponse = rumbleScraper.scrpVideoSource("v1mtkq9")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_6() {
        val jsoupResponse = rumbleScraper.scrpVideoSource("v1m37tu")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_7() {
        val jsoupResponse = rumbleScraper.scrpVideoSource("v1luvsi")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_8() {
        val jsoupResponse = rumbleScraper.scrpVideoSource("v1muz8p")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_9() {
        val jsoupResponse = rumbleScraper.scrpVideoSource("v1mob06")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_10() {
        val jsoupResponse = rumbleScraper.scrpVideoSource("v1mv1kb")
        val videoSource = jsoupResponse.data
