...
class RumbleVideoSourceScraperTests {
    ...
    private val rumbleScraper = RumbleVideoSourceScraper.createInstance()

    @Test
    fun videoSrcIsCorrectForUrl_1() {
        val jsoupResponse = rumbleScraper.scrape("v1ieskt")
    ...
    fun videoSrcIsCorrectForUrl_2() {
        val jsoupResponse = rumbleScraper.scrape("v1mh9nz")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_3() {
        val jsoupResponse = rumbleScraper.scrape("v1mll2a")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_4() {
        val jsoupResponse = rumbleScraper.scrape("v1mtkq9")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_6() {
        val jsoupResponse = rumbleScraper.scrape("v1m37tu")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_7() {
        val jsoupResponse = rumbleScraper.scrape("v1luvsi")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_8() {
        val jsoupResponse = rumbleScraper.scrape("v1muz8p")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_9() {
        val jsoupResponse = rumbleScraper.scrape("v1mob06")
        val videoSource = jsoupResponse.data
    ...
    fun videoSrcIsCorrectForUrl_10() {
        val jsoupResponse = rumbleScraper.scrape("v1mv1kb")
        val videoSource = jsoupResponse.data
